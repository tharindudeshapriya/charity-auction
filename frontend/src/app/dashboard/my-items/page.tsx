...
import { PlusCircle, Timer, Eye, Edit } from 'lucide-react';
...
export default function MyItemsPage() {
  ...
  const myItems = MOCK_AUCTIONS.filter(a => a.organizerId === 'org1');
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center">
        ...
        <Link href="/dashboard/create">
          <Button className="rounded-full gap-2 bg-primary font-bold shadow-lg shadow-primary/20">
              ...
              <CardContent className="p-6 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <div className="flex items-center gap-4 text-xs text-muted-foreground font-medium mb-4">
                    ...
                    <div>{item.bidCount} active bids</div>
                  </div>
                </div>
